...
class Sim:
    ...
    def movef(self, event):
        self.vest.dots("Front", [13,14], dur=0.1)
        self.robot.forward(5)
    
    def turnl(self, event):
        self.vest.dots("Front", [0,1], dur=0.1)
        self.vest.dots("Back", [0,1], dur=0.1)
        self.robot.turn(-math.pi/50) 

    def turnr(self, event):
        self.vest.dots("Front", [2,3], dur=0.1)
        self.vest.dots("Back", [2,3], dur=0.1)
        self.robot.turn(+math.pi/50)
