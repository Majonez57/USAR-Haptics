from hapticVest import HapticVest
...
def display_dead(vest, style):
    if "A" in style:
        ...
        vest.display_pattern('Small_Quare_BL',intensity=200, dur=1)
